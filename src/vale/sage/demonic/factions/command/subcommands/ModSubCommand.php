...
class ModSubCommand extends BaseSubCommand
{
	...
	public function onRun(CommandSender $sender, string $commandLabel, array $args): void {
		...
		$session->getFaction()->setRank($args["name"], "mod");
		$p = Server::getInstance()->getPlayerExact($args["name"]);
		if($p instanceof Player) {
			$p->sendMessage("§r§c§l(!) §r§cYou were promoted in your faction to Mod§c!");
		}
