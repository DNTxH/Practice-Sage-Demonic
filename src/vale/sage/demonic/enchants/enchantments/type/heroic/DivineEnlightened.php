...
class DivineEnlightened extends HeroicCustomEnchant {

    public function __construct() {
        parent::__construct(
            "Divine Enlightened",
            CustomEnchantIds::DIVINEENLIGHTENED,
        ...
        $this->callable = function (EntityDamageByEntityEvent $event, int $level) : void {
            ...
            if(mt_rand(0, 100) <= ($level * 10)) {
                $entity->setHealth($entity->getHealth() + ($level * 6));
            }
        };
    }
