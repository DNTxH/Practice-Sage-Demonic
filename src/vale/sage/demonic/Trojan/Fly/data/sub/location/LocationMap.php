...
namespace  vale\sage\demonic\Trojan\Fly\data\sub\location;

use  vale\sage\demonic\Trojan\Fly\data\PlayerData;
use  vale\sage\demonic\Trojan\Fly\data\process\NetworkStackLatencyHandler;
...
/**
 * Class LocationMap
 * @package  vale\sage\demonic\Trojan\Fly\data\sub
